...
namespace LecturerManagement.Services.AccountService
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(LecturerManagementSystemDbContext context, IMapper mapper, IHttpContextAccessor httpContext)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<ServiceResponse<GetAccountDto>> UpdateAccount(UpdateAccountDto updateAccount)
        {
            ...
            try
            {
                ...
                {
                    //if (_httpContext.HttpContext.User.FindFirstValue(ClaimTypes.Email).Equals("Admin"))
                    //{
